...
SELECT DEPARTMENT_ID AS "DEPARTMENT_CODE",COUNT(*) as "NUM OF EMPLOYEE" FROM DEPARTMENT GROUP BY DEPARTMENT_ID;
SELECT SUM(SALARY),DEPARTMENT_ID AS "DEPARTMENT_CODE" FROM DEPARTMENT GROUP BY DEPARTMENT_ID;
