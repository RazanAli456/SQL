CREATE TABLE IF NOT EXISTS NOBLE_WIN1(
YEAR INTEGER,
SUBJECT TEXT,
WINNER TEXT,
COUNTRY TEXT,
...
INSERT INTO NOBLE_WIN1 (YEAR,SUBJECT,WINNER,COUNTRY,CATEGORY) VALUES
...
SELECT * FROM NOBLE_WIN1 WHERE COUNTRY LIKE "SWEDEN%";
